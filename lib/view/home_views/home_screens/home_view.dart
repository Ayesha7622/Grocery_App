                ...
                child: Column(
                  children: [
                    CircleAvatar(
                      ...
                      child: Image(image: AssetImage(AppIcons.leaf)),
                ...
                child: Column(
                  children: [
                    CircleAvatar(
                      ...
                      child: Image(image: AssetImage(AppIcons.yellow)),
                    ),
                    SizedBox(
                      height: 10,
                    ),
                ...
                child: Column(
                  children: [
                    CircleAvatar(
                      ...
                      child: Image(image: AssetImage(AppIcons.purple)),
                    ),
                    SizedBox(
                      height: 10,
                    ),
                ...
                child: Column(
                  children: [
                    CircleAvatar(
                      ...
                      child: Image(image: AssetImage(AppIcons.blue)),
                    ),
                    SizedBox(
                      height: 10,
                    ),
                ...
                child: Column(
                  children: [
                    CircleAvatar(
                      ...
                      // ),
                      child: Image(image: AssetImage(AppIcons.vacuum)),
                    ),
                    SizedBox(
                      height: 10,
                    ),
